...
--Z:\Development\Projekte\SEN\100246_IDS Weiterentwicklung - Table-Top\Display Programmierung\GUI Ordner wxLua\wxLua-2.8.12.3-Lua-5.1.5-MSW-Ansi
package.cpath = package.cpath..";./?.dll;./?.so;../lib/?.so;../lib/vc_dll/?.dll;../lib/bcc_dll/?.dll;../lib/mingw_dll/?.dll;"

print("LUA MODULES:\n",(package.path:gsub("%;","\n\t")),"\n\nC MODULES:\n",(package.cpath:gsub("%;","\n\t")))
--print('active directory', package.cpath) ; 
require("wx")
